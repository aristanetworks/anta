...
from anta.tests.stp import VerifySTPBlockedPorts, VerifySTPCounters, VerifySTPForwardingPorts, VerifySTPMode
from tests.lib.utils import generate_test_ids_list

from .data import INPUT_STP_BLOCKED_PORTS, INPUT_STP_COUNTERS, INPUT_STP_FORWARDING_PORTS, INPUT_STP_MODE
