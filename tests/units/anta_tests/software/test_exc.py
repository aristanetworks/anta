...
from anta.tests.software import VerifyEOSExtensions, VerifyEOSVersion, VerifyFieldNotice44Resolution, VerifyTerminAttrVersion
from tests.lib.utils import generate_test_ids_list

from .data import INPUT_FIELD_NOTICE_44_RESOLUTION, INPUT_VERIFY_EOS_EXTENSIONS, INPUT_VERIFY_EOS_VERSION, INPUT_VERIFY_TERMINATTR_VERSION
