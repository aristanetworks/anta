...
DATA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "expected": {
            ...
            "messages": [
                "Following BFD peers are not configured or timers are not correct:\n"
                "{'192.0.255.7': {'default': {'tx_interval': 1300, 'rx_interval': 1200, 'multiplier': 4, 'detection_time': 4000}}, "
                "'192.0.255.70': {'MGMT': {'tx_interval': 120, 'rx_interval': 120, 'multiplier': 5, 'detection_time': 4000}}}"
            ],
        },
    },
    {
