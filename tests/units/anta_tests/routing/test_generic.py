...
DATA: AntaUnitTestDataDict = {
    ...
    (VerifyRoutingStatus, "failure-ip6multicast-not-found"): {
        ...
        "expected": {
            "result": AntaTestStatus.FAILURE,
            "messages": [
                "IPv6 multicast routing enabled status mismatch - Expected: True Actual: Not found",
            ],
        },
    },
    (VerifyRoutingStatus, "failure-ipv4multicast-not-found"): {
        ...
        "expected": {
            "result": AntaTestStatus.FAILURE,
            "messages": ["IPv4 multicast routing enabled status mismatch - Expected: True Actual: Not found"],
        },
    },
