...
| ------------------| ----------- | ------------- | ------------- | ------------- | ----------- | -------------------| ------------------|
| s1-leaf1 | 30 | 10 | 9 | 9 | 2 | AVT, Field Notices, Flow Tracking, Hardware, LANZ, PTP, VXLAN | Cvx, Greent, Interfaces, Logging, VLAN |
...
| s1-leaf1 | Logging | VerifyLoggingAccounting | Verifies if AAA accounting logs are generated. | - | failure | AAA accounting logs are not generated |
