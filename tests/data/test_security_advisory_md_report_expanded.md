...
| &nbsp;&nbsp;└── | 🔵&nbsp;CVE-2026-12102 | ✅&nbsp;Not Affected | The device is not affected by the low-severity issue because process diagnostics are restricted. | - |
...
| &nbsp;&nbsp;└── | 🟡&nbsp;CVE-2025-0936 | ❓&nbsp;Inconclusive | The assessment is inconclusive because required gNOI File and gNSI Authz evidence is unavailable. | Upgrade EOS to a remediated release when one is published. |
