...
| DC1-LEAF1 | 🔴&nbsp;CVE-2026-60002 | ❓&nbsp;Inconclusive | The assessment is inconclusive and the device may be affected. Indications: EOS version '4.32.4M' is affected, openssh-clients '9.9p1' is affected, and SSH client strict host-key checking is effective. Unresolved: SSH server trustworthiness is external state. | Upgrade to EOS 4.35.6M or later in the 4.35 train or EOS 4.34.8M or later in the 4.34 train.<br>Refer to the advisory to determine whether the unresolved condition applies, for newly fixed releases, and for current mitigation guidance. |
