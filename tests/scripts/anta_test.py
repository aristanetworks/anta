...
inventory = AntaInventory(inventory_file=f"{dir_path}/../../examples/inventory.yml",
username=username, password=password, enable_password=enable_password, auto_connect=True, timeout=2)
