...
[This test catalog example](https://github.com/aristanetworks/anta/blob/main/examples/tests.yaml) is maintained with all non-advisory tests defined in the `anta.tests` Python module.
