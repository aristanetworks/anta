...
class AtomicResult(TypedDict):
    ...
    result: Literal[AntaTestStatus.SUCCESS, AntaTestStatus.INCONCLUSIVE, AntaTestStatus.FAILURE, AntaTestStatus.SKIPPED]  # The expected status of this atomic result.
