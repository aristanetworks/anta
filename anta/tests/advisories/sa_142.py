...
TRAFFIC_POLICY_PATH = ExposurePath(
    name="Traffic Policy",
    platform_families=(
        PlatformFamily.SERIES_710_XP,
        PlatformFamily.SERIES_720_DF,
        PlatformFamily.SERIES_720_DP,
        PlatformFamily.SERIES_720_DT,
        PlatformFamily.SERIES_720_XP,
        PlatformFamily.SERIES_720_XDM,
        PlatformFamily.SERIES_722_XPM,
...
def _version_relation(path: ExposurePath, device_version: EOSVersion | None) -> VersionRelation | None:
...
def _full_remediation_plan(version: AvailableFact[EOSVersion]) -> RemediationPlan:
    ...
    return RemediationPlan(
        Sequence(
            (
                software_version_action(FIXED_RELEASES, current_version=version.value),
