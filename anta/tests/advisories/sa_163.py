...
from anta._advisory.facts.models import AvailableFact, Fact, FactDefinition, FeatureState, FeatureValue, MitigationState, UnavailableFact
...
def _assess_sa163(version: Fact[EOSVersion], exposure: Fact[FeatureValue], mitigation: Fact[LevelZeroCommandAuthorizationFact]) -> VulnerabilityResult:
