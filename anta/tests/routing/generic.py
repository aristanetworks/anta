    ...
    * Failure: The test will fail if the routing status doesn't match the expected configuration.
    ...
    def test(self) -> None:
        ...
        actual_routing_status: dict[str, Any] = {
            ...
            "ipv4_multicast": get_value(command_output, "multicastRouting.ipMulticastEnabled", "Not configured"),
            "ipv6_multicast": get_value(command_output, "multicastRouting.ip6MulticastEnabled", "Not configured"),
